...
class InventarioResourceIT {
    ...
    private static final Integer DEFAULT_CANTIDAD_MINIMA_EST = 1;
    private static final Integer UPDATED_CANTIDAD_MINIMA_EST = 2;

    private static final Integer DEFAULT_CANTIDAD_MAXIMA_EST = 1;
    private static final Integer UPDATED_CANTIDAD_MAXIMA_EST = 2;
    ...
    public static Inventario createEntity(EntityManager em) {
        Inventario inventario = new Inventario()
            ...
            .cantidadMinimaEst(DEFAULT_CANTIDAD_MINIMA_EST)
            .cantidadMaximaEst(DEFAULT_CANTIDAD_MAXIMA_EST)
    ...
    public static Inventario createUpdatedEntity(EntityManager em) {
        Inventario inventario = new Inventario()
            ...
            .cantidadMinimaEst(UPDATED_CANTIDAD_MINIMA_EST)
            .cantidadMaximaEst(UPDATED_CANTIDAD_MAXIMA_EST)
    ...
    void createInventario() throws Exception {
        ...
        assertThat(testInventario.getCantidadMinimaEst()).isEqualTo(DEFAULT_CANTIDAD_MINIMA_EST);
        assertThat(testInventario.getCantidadMaximaEst()).isEqualTo(DEFAULT_CANTIDAD_MAXIMA_EST);
        assertThat(testInventario.getStatus()).isEqualTo(DEFAULT_STATUS);
        assertThat(testInventario.getCreateByUser()).isEqualTo(DEFAULT_CREATE_BY_USER);
        assertThat(testInventario.getCreatedOn()).isEqualTo(DEFAULT_CREATED_ON);
        assertThat(testInventario.getModifyByUser()).isEqualTo(DEFAULT_MODIFY_BY_USER);
        assertThat(testInventario.getModifiedOn()).isEqualTo(DEFAULT_MODIFIED_ON);
        assertThat(testInventario.getAuditStatus()).isEqualTo(DEFAULT_AUDIT_STATUS);
    }
    ...
    void getAllInventarios() throws Exception {
        ...
        restInventarioMockMvc
            ...
            .andExpect(jsonPath("$.[*].cantidadMinimaEst").value(hasItem(DEFAULT_CANTIDAD_MINIMA_EST)))
            .andExpect(jsonPath("$.[*].cantidadMaximaEst").value(hasItem(DEFAULT_CANTIDAD_MAXIMA_EST)))
    ...
    void getInventario() throws Exception {
        ...
        restInventarioMockMvc
            ...
            .andExpect(jsonPath("$.cantidadMinimaEst").value(DEFAULT_CANTIDAD_MINIMA_EST))
            .andExpect(jsonPath("$.cantidadMaximaEst").value(DEFAULT_CANTIDAD_MAXIMA_EST))
    ...
    void putNewInventario() throws Exception {
        ...
        assertThat(testInventario.getCantidadMinimaEst()).isEqualTo(UPDATED_CANTIDAD_MINIMA_EST);
        assertThat(testInventario.getCantidadMaximaEst()).isEqualTo(UPDATED_CANTIDAD_MAXIMA_EST);
        assertThat(testInventario.getStatus()).isEqualTo(UPDATED_STATUS);
        assertThat(testInventario.getCreateByUser()).isEqualTo(UPDATED_CREATE_BY_USER);
        assertThat(testInventario.getCreatedOn()).isEqualTo(UPDATED_CREATED_ON);
        assertThat(testInventario.getModifyByUser()).isEqualTo(UPDATED_MODIFY_BY_USER);
        assertThat(testInventario.getModifiedOn()).isEqualTo(UPDATED_MODIFIED_ON);
        assertThat(testInventario.getAuditStatus()).isEqualTo(UPDATED_AUDIT_STATUS);
    }
