...
class VentaResourceIT {
    ...
    void createVenta() throws Exception {
        ...
        assertThat(testVenta.getCreateByUser()).isEqualTo(DEFAULT_CREATE_BY_USER);
        assertThat(testVenta.getCreatedOn()).isEqualTo(DEFAULT_CREATED_ON);
        assertThat(testVenta.getModifyByUser()).isEqualTo(DEFAULT_MODIFY_BY_USER);
        assertThat(testVenta.getModifiedOn()).isEqualTo(DEFAULT_MODIFIED_ON);
        assertThat(testVenta.getAuditStatus()).isEqualTo(DEFAULT_AUDIT_STATUS);
    }
    ...
    void putNewVenta() throws Exception {
        ...
        assertThat(testVenta.getCreateByUser()).isEqualTo(UPDATED_CREATE_BY_USER);
        assertThat(testVenta.getCreatedOn()).isEqualTo(UPDATED_CREATED_ON);
        assertThat(testVenta.getModifyByUser()).isEqualTo(UPDATED_MODIFY_BY_USER);
        assertThat(testVenta.getModifiedOn()).isEqualTo(UPDATED_MODIFIED_ON);
        assertThat(testVenta.getAuditStatus()).isEqualTo(UPDATED_AUDIT_STATUS);
    }
