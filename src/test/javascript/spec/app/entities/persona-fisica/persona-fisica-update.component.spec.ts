...
import PersonaFisicaUpdateComponent from '@/entities/persona-fisica/persona-fisica-update.vue';
import PersonaFisicaClass from '@/entities/persona-fisica/persona-fisica-update.component';
...
describe('Component Tests', () => {
  describe('PersonaFisica Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<PersonaFisicaClass>(PersonaFisicaUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        // GIVEN
        const entity = { id: 123 };
        comp.personaFisica = entity;
        personaFisicaServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(personaFisicaServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.personaFisica = entity;
        personaFisicaServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(personaFisicaServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        personaFisicaServiceStub.retrieve.resolves([foundPersonaFisica]);
