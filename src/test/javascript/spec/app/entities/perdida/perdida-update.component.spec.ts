...
import PerdidaUpdateComponent from '@/entities/perdida/perdida-update.vue';
import PerdidaClass from '@/entities/perdida/perdida-update.component';
...
describe('Component Tests', () => {
  describe('Perdida Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<PerdidaClass>(PerdidaUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.perdida = entity;
        perdidaServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(perdidaServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.perdida = entity;
        perdidaServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(perdidaServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        perdidaServiceStub.retrieve.resolves([foundPerdida]);
