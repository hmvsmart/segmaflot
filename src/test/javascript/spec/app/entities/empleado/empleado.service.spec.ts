    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = Object.assign(
          {
            finicio: dayjs(currentDate).format(DATE_FORMAT),
      ...
      it('should not create a Empleado', async () => {
      ...
      it('should not update a Empleado', async () => {
      ...
      it('should partial update a Empleado', async () => {
      ...
      it('should not partial update a Empleado', async () => {
      ...
      it('should not return a list of Empleado', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Empleado', async () => {
