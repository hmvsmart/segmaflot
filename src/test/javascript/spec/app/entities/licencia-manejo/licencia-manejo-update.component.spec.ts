...
import LicenciaManejoUpdateComponent from '@/entities/licencia-manejo/licencia-manejo-update.vue';
import LicenciaManejoClass from '@/entities/licencia-manejo/licencia-manejo-update.component';
...
describe('Component Tests', () => {
  describe('LicenciaManejo Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<LicenciaManejoClass>(LicenciaManejoUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        // GIVEN
        const entity = { id: 123 };
        comp.licenciaManejo = entity;
        licenciaManejoServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(licenciaManejoServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.licenciaManejo = entity;
        licenciaManejoServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(licenciaManejoServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        licenciaManejoServiceStub.retrieve.resolves([foundLicenciaManejo]);
