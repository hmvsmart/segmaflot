...
describe('Service Tests', () => {
  describe('Contacto Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Contacto(123, 'AAAAAAA', 'AAAAAAA', false, 'AAAAAAA', currentDate, 'AAAAAAA', currentDate, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Contacto', async () => {
      ...
      it('should not update a Contacto', async () => {
      ...
      it('should partial update a Contacto', async () => {
      ...
      it('should not partial update a Contacto', async () => {
      ...
      it('should not return a list of Contacto', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Contacto', async () => {
