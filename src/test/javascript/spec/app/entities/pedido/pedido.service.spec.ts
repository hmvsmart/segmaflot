...
describe('Service Tests', () => {
  describe('Pedido Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Pedido(123, currentDate, 'AAAAAAA', currentDate, 'AAAAAAA', currentDate, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Pedido', async () => {
      ...
      it('should not update a Pedido', async () => {
      ...
      it('should partial update a Pedido', async () => {
      ...
      it('should not partial update a Pedido', async () => {
      ...
      it('should not return a list of Pedido', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Pedido', async () => {
