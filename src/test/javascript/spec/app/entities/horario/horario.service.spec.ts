...
describe('Service Tests', () => {
  describe('Horario Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Horario(123, currentDate, false, 'AAAAAAA', currentDate, 'AAAAAAA', currentDate, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Horario', async () => {
      ...
      it('should not update a Horario', async () => {
      ...
      it('should partial update a Horario', async () => {
      ...
      it('should not partial update a Horario', async () => {
      ...
      it('should not return a list of Horario', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Horario', async () => {
