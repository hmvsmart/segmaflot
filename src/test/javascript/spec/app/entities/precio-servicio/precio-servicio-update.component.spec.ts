...
import PrecioServicioUpdateComponent from '@/entities/precio-servicio/precio-servicio-update.vue';
import PrecioServicioClass from '@/entities/precio-servicio/precio-servicio-update.component';
...
describe('Component Tests', () => {
  describe('PrecioServicio Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<PrecioServicioClass>(PrecioServicioUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        precioServicioServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(precioServicioServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.precioServicio = entity;
        precioServicioServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(precioServicioServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        precioServicioServiceStub.retrieve.resolves([foundPrecioServicio]);
