...
import ReporteUpdateComponent from '@/entities/reporte/reporte-update.vue';
import ReporteClass from '@/entities/reporte/reporte-update.component';
...
describe('Component Tests', () => {
  describe('Reporte Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<ReporteClass>(ReporteUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.reporte = entity;
        reporteServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(reporteServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.reporte = entity;
        reporteServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(reporteServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        reporteServiceStub.retrieve.resolves([foundReporte]);
