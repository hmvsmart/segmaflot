...
import ExperienciaHabilidadUpdateComponent from '@/entities/experiencia-habilidad/experiencia-habilidad-update.vue';
import ExperienciaHabilidadClass from '@/entities/experiencia-habilidad/experiencia-habilidad-update.component';
...
describe('Component Tests', () => {
  describe('ExperienciaHabilidad Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<ExperienciaHabilidadClass>(ExperienciaHabilidadUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        // GIVEN
        const entity = { id: 123 };
        comp.experienciaHabilidad = entity;
        experienciaHabilidadServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(experienciaHabilidadServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.experienciaHabilidad = entity;
        experienciaHabilidadServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(experienciaHabilidadServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        experienciaHabilidadServiceStub.retrieve.resolves([foundExperienciaHabilidad]);
