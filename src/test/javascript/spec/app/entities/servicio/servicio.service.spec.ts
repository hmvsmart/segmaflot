...
import { Servicio } from '@/shared/model/servicio.model';
    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = Object.assign(
          {
            duracionEstimada: dayjs(currentDate).format(DATE_TIME_FORMAT),
      ...
      it('should not create a Servicio', async () => {
      ...
      it('should not update a Servicio', async () => {
      ...
      it('should not partial update a Servicio', async () => {
      ...
      it('should not return a list of Servicio', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Servicio', async () => {
