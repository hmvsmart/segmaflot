...
import VehiculoUpdateComponent from '@/entities/vehiculo/vehiculo-update.vue';
import VehiculoClass from '@/entities/vehiculo/vehiculo-update.component';
...
describe('Component Tests', () => {
  describe('Vehiculo Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<VehiculoClass>(VehiculoUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        vehiculoServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(vehiculoServiceStub.update.calledWith(entity)).toBeTruthy();
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        vehiculoServiceStub.retrieve.resolves([foundVehiculo]);
