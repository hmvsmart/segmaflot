  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="segmaflotApp.persona.home.createOrEditLabel"
          data-cy="PersonaCreateUpdateHeading"
          v-text="$t('segmaflotApp.persona.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <button
            ...
            :disabled="$v.persona.$invalid || isSaving"
