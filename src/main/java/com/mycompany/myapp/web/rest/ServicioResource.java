...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Servicio}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Servicio> partialUpdateServicio(
        ...
        Optional<Servicio> result = servicioRepository
            ...
            .map(existingServicio -> {
                ...
                if (servicio.getDescripcionContentType() != null) {
                    existingServicio.setDescripcionContentType(servicio.getDescripcionContentType());
                }
                if (servicio.getDuracionEstimada() != null) {
                    existingServicio.setDuracionEstimada(servicio.getDuracionEstimada());
                }
                if (servicio.getCreateByUser() != null) {
                    existingServicio.setCreateByUser(servicio.getCreateByUser());
                }
                if (servicio.getCreatedOn() != null) {
                    existingServicio.setCreatedOn(servicio.getCreatedOn());
                }
                if (servicio.getModifyByUser() != null) {
                    existingServicio.setModifyByUser(servicio.getModifyByUser());
                }
                if (servicio.getModifiedOn() != null) {
                    existingServicio.setModifiedOn(servicio.getModifiedOn());
                }
                if (servicio.getAuditStatus() != null) {
                    existingServicio.setAuditStatus(servicio.getAuditStatus());
                }
