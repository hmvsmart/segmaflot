        ...
        Optional<Direccion> result = direccionRepository
            ...
            .map(existingDireccion -> {
                ...
                if (direccion.getNumeroExterior() != null) {
                    existingDireccion.setNumeroExterior(direccion.getNumeroExterior());
                }
                if (direccion.getNumeroInterior() != null) {
                    existingDireccion.setNumeroInterior(direccion.getNumeroInterior());
                }
                if (direccion.getCreateByUser() != null) {
                    existingDireccion.setCreateByUser(direccion.getCreateByUser());
                }
                if (direccion.getCreatedOn() != null) {
                    existingDireccion.setCreatedOn(direccion.getCreatedOn());
                }
                if (direccion.getModifyByUser() != null) {
                    existingDireccion.setModifyByUser(direccion.getModifyByUser());
                }
                if (direccion.getModifiedOn() != null) {
                    existingDireccion.setModifiedOn(direccion.getModifiedOn());
                }
                if (direccion.getAuditStatus() != null) {
                    existingDireccion.setAuditStatus(direccion.getAuditStatus());
                }
