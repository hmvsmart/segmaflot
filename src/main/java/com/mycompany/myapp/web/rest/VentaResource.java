    ...
    public ResponseEntity<Venta> partialUpdateVenta(@PathVariable(value = "id", required = false) final Long id, @RequestBody Venta venta)
        ...
        Optional<Venta> result = ventaRepository
            ...
            .map(existingVenta -> {
                ...
                if (venta.getCreateByUser() != null) {
                    existingVenta.setCreateByUser(venta.getCreateByUser());
                }
                if (venta.getCreatedOn() != null) {
                    existingVenta.setCreatedOn(venta.getCreatedOn());
                }
                if (venta.getModifyByUser() != null) {
                    existingVenta.setModifyByUser(venta.getModifyByUser());
                }
                if (venta.getModifiedOn() != null) {
                    existingVenta.setModifiedOn(venta.getModifiedOn());
                }
                if (venta.getAuditStatus() != null) {
                    existingVenta.setAuditStatus(venta.getAuditStatus());
                }
