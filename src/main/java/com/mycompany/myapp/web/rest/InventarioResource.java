    ...
    public ResponseEntity<Inventario> partialUpdateInventario(
        ...
        Optional<Inventario> result = inventarioRepository
            ...
            .map(existingInventario -> {
                ...
                if (inventario.getCantidadMinimaEst() != null) {
                    existingInventario.setCantidadMinimaEst(inventario.getCantidadMinimaEst());
                }
                if (inventario.getCantidadMaximaEst() != null) {
                    existingInventario.setCantidadMaximaEst(inventario.getCantidadMaximaEst());
                }
                if (inventario.getStatus() != null) {
                    existingInventario.setStatus(inventario.getStatus());
                }
                if (inventario.getCreateByUser() != null) {
                    existingInventario.setCreateByUser(inventario.getCreateByUser());
                }
                if (inventario.getCreatedOn() != null) {
                    existingInventario.setCreatedOn(inventario.getCreatedOn());
                }
                if (inventario.getModifyByUser() != null) {
                    existingInventario.setModifyByUser(inventario.getModifyByUser());
                }
                if (inventario.getModifiedOn() != null) {
                    existingInventario.setModifiedOn(inventario.getModifiedOn());
                }
                if (inventario.getAuditStatus() != null) {
                    existingInventario.setAuditStatus(inventario.getAuditStatus());
                }
