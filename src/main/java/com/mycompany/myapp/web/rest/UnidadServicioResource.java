...
public class UnidadServicioResource {
    ...
    public ResponseEntity<UnidadServicio> updateUnidadServicio(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, unidadServicio.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<UnidadServicio> partialUpdateUnidadServicio(
        ...
        Optional<UnidadServicio> result = unidadServicioRepository
            ...
            .map(existingUnidadServicio -> {
                ...
                if (unidadServicio.getTotalEstimado() != null) {
                    existingUnidadServicio.setTotalEstimado(unidadServicio.getTotalEstimado());
                }
                if (unidadServicio.getTotalReal() != null) {
                    existingUnidadServicio.setTotalReal(unidadServicio.getTotalReal());
                }
                if (unidadServicio.getObservacionesGenerales() != null) {
                    existingUnidadServicio.setObservacionesGenerales(unidadServicio.getObservacionesGenerales());
                }
                if (unidadServicio.getObservacionesGeneralesContentType() != null) {
                    existingUnidadServicio.setObservacionesGeneralesContentType(unidadServicio.getObservacionesGeneralesContentType());
                }
                if (unidadServicio.getCreateByUser() != null) {
                    existingUnidadServicio.setCreateByUser(unidadServicio.getCreateByUser());
                }
                if (unidadServicio.getCreatedOn() != null) {
                    existingUnidadServicio.setCreatedOn(unidadServicio.getCreatedOn());
                }
                if (unidadServicio.getModifyByUser() != null) {
                    existingUnidadServicio.setModifyByUser(unidadServicio.getModifyByUser());
                }
                if (unidadServicio.getModifiedOn() != null) {
                    existingUnidadServicio.setModifiedOn(unidadServicio.getModifiedOn());
                }
                if (unidadServicio.getAuditStatus() != null) {
                    existingUnidadServicio.setAuditStatus(unidadServicio.getAuditStatus());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, unidadServicio.getId().toString())
        );
    }
    ...
    public ResponseEntity<UnidadServicio> getUnidadServicio(@PathVariable Long id) {
    ...
    public ResponseEntity<Void> deleteUnidadServicio(@PathVariable Long id) {
