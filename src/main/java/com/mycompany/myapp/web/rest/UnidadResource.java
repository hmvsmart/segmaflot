...
public class UnidadResource {
    ...
    public ResponseEntity<Unidad> updateUnidad(@PathVariable(value = "id", required = false) final Long id, @RequestBody Unidad unidad)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, unidad.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Unidad> partialUpdateUnidad(
        ...
        Optional<Unidad> result = unidadRepository
            ...
            .map(existingUnidad -> {
                if (unidad.getFecha() != null) {
                    existingUnidad.setFecha(unidad.getFecha());
                }
                if (unidad.getNumeroSerie() != null) {
                    existingUnidad.setNumeroSerie(unidad.getNumeroSerie());
                }
                if (unidad.getKmActual() != null) {
                    existingUnidad.setKmActual(unidad.getKmActual());
                }
                if (unidad.getTipoAdquisicion() != null) {
                    existingUnidad.setTipoAdquisicion(unidad.getTipoAdquisicion());
                }
                if (unidad.getImagen() != null) {
                    existingUnidad.setImagen(unidad.getImagen());
                }
                if (unidad.getImagenContentType() != null) {
                    existingUnidad.setImagenContentType(unidad.getImagenContentType());
                }
                if (unidad.getColor() != null) {
                    existingUnidad.setColor(unidad.getColor());
                }
                if (unidad.getDescripcion() != null) {
                    existingUnidad.setDescripcion(unidad.getDescripcion());
                }
                if (unidad.getDescripcionContentType() != null) {
                    existingUnidad.setDescripcionContentType(unidad.getDescripcionContentType());
                }
                if (unidad.getStatus() != null) {
                    existingUnidad.setStatus(unidad.getStatus());
                }
                if (unidad.getCreateByUser() != null) {
                    existingUnidad.setCreateByUser(unidad.getCreateByUser());
                }
                if (unidad.getCreatedOn() != null) {
                    existingUnidad.setCreatedOn(unidad.getCreatedOn());
                }
                if (unidad.getModifyByUser() != null) {
                    existingUnidad.setModifyByUser(unidad.getModifyByUser());
                }
                if (unidad.getModifiedOn() != null) {
                    existingUnidad.setModifiedOn(unidad.getModifiedOn());
                }
                if (unidad.getAuditStatus() != null) {
                    existingUnidad.setAuditStatus(unidad.getAuditStatus());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, unidad.getId().toString())
        );
    }
