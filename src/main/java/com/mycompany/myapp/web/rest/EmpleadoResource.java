        ...
        Optional<Empleado> result = empleadoRepository
            ...
            .map(existingEmpleado -> {
                if (empleado.getRfc() != null) {
                    existingEmpleado.setRfc(empleado.getRfc());
                }
                if (empleado.getNss() != null) {
                    existingEmpleado.setNss(empleado.getNss());
                }
                if (empleado.getFinicio() != null) {
                    existingEmpleado.setFinicio(empleado.getFinicio());
                }
                ...
                if (empleado.getDiaPago() != null) {
                    existingEmpleado.setDiaPago(empleado.getDiaPago());
                }
                if (empleado.getTipoPago() != null) {
                    existingEmpleado.setTipoPago(empleado.getTipoPago());
                }
                if (empleado.getCreateByUser() != null) {
                    existingEmpleado.setCreateByUser(empleado.getCreateByUser());
                }
                if (empleado.getCreatedOn() != null) {
                    existingEmpleado.setCreatedOn(empleado.getCreatedOn());
                }
                if (empleado.getModifyByUser() != null) {
                    existingEmpleado.setModifyByUser(empleado.getModifyByUser());
                }
                if (empleado.getModifiedOn() != null) {
                    existingEmpleado.setModifiedOn(empleado.getModifiedOn());
                }
                if (empleado.getAuditStatus() != null) {
                    existingEmpleado.setAuditStatus(empleado.getAuditStatus());
                }
