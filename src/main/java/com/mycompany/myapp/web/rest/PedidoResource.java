...
public class PedidoResource {
    ...
    public ResponseEntity<Pedido> updatePedido(@PathVariable(value = "id", required = false) final Long id, @RequestBody Pedido pedido)
    ...
    public ResponseEntity<Pedido> partialUpdatePedido(
        ...
        Optional<Pedido> result = pedidoRepository
            ...
            .map(existingPedido -> {
                ...
                if (pedido.getCreateByUser() != null) {
                    existingPedido.setCreateByUser(pedido.getCreateByUser());
                }
                if (pedido.getCreatedOn() != null) {
                    existingPedido.setCreatedOn(pedido.getCreatedOn());
                }
                if (pedido.getModifyByUser() != null) {
                    existingPedido.setModifyByUser(pedido.getModifyByUser());
                }
                if (pedido.getModifiedOn() != null) {
                    existingPedido.setModifiedOn(pedido.getModifiedOn());
                }
                if (pedido.getAuditStatus() != null) {
                    existingPedido.setAuditStatus(pedido.getAuditStatus());
                }
