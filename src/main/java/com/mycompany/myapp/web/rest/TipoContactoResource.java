...
public class TipoContactoResource {
    ...
    public TipoContactoResource(TipoContactoRepository tipoContactoRepository) {
    ...
    public ResponseEntity<TipoContacto> createTipoContacto(@RequestBody TipoContacto tipoContacto) throws URISyntaxException {
        ...
        TipoContacto result = tipoContactoRepository.save(tipoContacto);
    ...
    public ResponseEntity<TipoContacto> updateTipoContacto(
        ...
        @RequestBody TipoContacto tipoContacto
    ...
    public ResponseEntity<TipoContacto> partialUpdateTipoContacto(
        ...
        Optional<TipoContacto> result = tipoContactoRepository
            .findById(tipoContacto.getId())
            .map(existingTipoContacto -> {
                if (tipoContacto.getNombre() != null) {
                    existingTipoContacto.setNombre(tipoContacto.getNombre());
                }
                if (tipoContacto.getCreateByUser() != null) {
                    existingTipoContacto.setCreateByUser(tipoContacto.getCreateByUser());
                }
                if (tipoContacto.getCreatedOn() != null) {
                    existingTipoContacto.setCreatedOn(tipoContacto.getCreatedOn());
                }
                if (tipoContacto.getModifyByUser() != null) {
                    existingTipoContacto.setModifyByUser(tipoContacto.getModifyByUser());
                }
                if (tipoContacto.getModifiedOn() != null) {
                    existingTipoContacto.setModifiedOn(tipoContacto.getModifiedOn());
                }
                if (tipoContacto.getAuditStatus() != null) {
                    existingTipoContacto.setAuditStatus(tipoContacto.getAuditStatus());
                }
    ...
    public ResponseEntity<TipoContacto> getTipoContacto(@PathVariable Long id) {
        ...
        Optional<TipoContacto> tipoContacto = tipoContactoRepository.findById(id);
