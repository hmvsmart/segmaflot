...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Sucursal}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Sucursal> result = sucursalRepository
            ...
            .map(existingSucursal -> {
                ...
                if (sucursal.getTipoSucursal() != null) {
                    existingSucursal.setTipoSucursal(sucursal.getTipoSucursal());
                }
                if (sucursal.getTelefono() != null) {
                    existingSucursal.setTelefono(sucursal.getTelefono());
                }
                if (sucursal.getStatus() != null) {
                    existingSucursal.setStatus(sucursal.getStatus());
                }
                if (sucursal.getCreateByUser() != null) {
                    existingSucursal.setCreateByUser(sucursal.getCreateByUser());
                }
                if (sucursal.getCreatedOn() != null) {
                    existingSucursal.setCreatedOn(sucursal.getCreatedOn());
                }
                if (sucursal.getModifyByUser() != null) {
                    existingSucursal.setModifyByUser(sucursal.getModifyByUser());
                }
                if (sucursal.getModifiedOn() != null) {
                    existingSucursal.setModifiedOn(sucursal.getModifiedOn());
                }
                if (sucursal.getAuditStatus() != null) {
                    existingSucursal.setAuditStatus(sucursal.getAuditStatus());
                }
