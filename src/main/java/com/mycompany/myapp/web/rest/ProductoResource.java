    ...
    public ResponseEntity<Producto> partialUpdateProducto(
        ...
        Optional<Producto> result = productoRepository
            ...
            .map(existingProducto -> {
                ...
                if (producto.getUso() != null) {
                    existingProducto.setUso(producto.getUso());
                }
                if (producto.getDescripcion() != null) {
                    existingProducto.setDescripcion(producto.getDescripcion());
                }
                if (producto.getDescripcionContentType() != null) {
                    existingProducto.setDescripcionContentType(producto.getDescripcionContentType());
                }
                if (producto.getOtros() != null) {
                    existingProducto.setOtros(producto.getOtros());
                }
                if (producto.getOtrosContentType() != null) {
                    existingProducto.setOtrosContentType(producto.getOtrosContentType());
                }
                if (producto.getCreateByUser() != null) {
                    existingProducto.setCreateByUser(producto.getCreateByUser());
                }
                if (producto.getCreatedOn() != null) {
                    existingProducto.setCreatedOn(producto.getCreatedOn());
                }
                if (producto.getModifyByUser() != null) {
                    existingProducto.setModifyByUser(producto.getModifyByUser());
                }
                if (producto.getModifiedOn() != null) {
                    existingProducto.setModifiedOn(producto.getModifiedOn());
                }
                if (producto.getAuditStatus() != null) {
                    existingProducto.setAuditStatus(producto.getAuditStatus());
                }
