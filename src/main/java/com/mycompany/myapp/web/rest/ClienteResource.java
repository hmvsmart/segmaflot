        ...
        Optional<Cliente> result = clienteRepository
            ...
            .map(existingCliente -> {
                if (cliente.getFecha() != null) {
                    existingCliente.setFecha(cliente.getFecha());
                }
                if (cliente.getObservaciones() != null) {
                    existingCliente.setObservaciones(cliente.getObservaciones());
                }
                if (cliente.getObservacionesContentType() != null) {
                    existingCliente.setObservacionesContentType(cliente.getObservacionesContentType());
                }
                if (cliente.getCreateByUser() != null) {
                    existingCliente.setCreateByUser(cliente.getCreateByUser());
                }
                if (cliente.getCreatedOn() != null) {
                    existingCliente.setCreatedOn(cliente.getCreatedOn());
                }
                if (cliente.getModifyByUser() != null) {
                    existingCliente.setModifyByUser(cliente.getModifyByUser());
                }
                if (cliente.getModifiedOn() != null) {
                    existingCliente.setModifiedOn(cliente.getModifiedOn());
                }
                if (cliente.getAuditStatus() != null) {
                    existingCliente.setAuditStatus(cliente.getAuditStatus());
                }
