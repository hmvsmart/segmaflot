 ...
 */
@Entity
@Table(name = "lista_servicio")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class ListaServicio implements Serializable {
    ...
    public ListaServicio id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ListaServicio cantidad(Integer cantidad) {
    ...
    public ListaServicio createByUser(String createByUser) {
    ...
    public ListaServicio createdOn(Instant createdOn) {
    ...
    public ListaServicio modifyByUser(String modifyByUser) {
    ...
    public ListaServicio modifiedOn(Instant modifiedOn) {
    ...
    public ListaServicio auditStatus(String auditStatus) {
    ...
    public ListaServicio servicio(Servicio servicio) {
    ...
    public ListaServicio unidadServicio(UnidadServicio unidadServicio) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ListaServicio)) {
            return false;
        }
        return id != null && id.equals(((ListaServicio) o).id);
    }
