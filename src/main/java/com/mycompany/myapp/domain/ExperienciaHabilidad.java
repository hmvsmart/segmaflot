...
/**
 * A ExperienciaHabilidad.
 */
@Entity
@Table(name = "experiencia_habilidad")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class ExperienciaHabilidad implements Serializable {
    ...
    public ExperienciaHabilidad id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public ExperienciaHabilidad fecha(LocalDate fecha) {
        this.setFecha(fecha);
        return this;
    }
    ...
    public ExperienciaHabilidad descripcion(byte[] descripcion) {
    ...
    public ExperienciaHabilidad descripcionContentType(String descripcionContentType) {
    ...
    public ExperienciaHabilidad createByUser(String createByUser) {
    ...
    public ExperienciaHabilidad createdOn(Instant createdOn) {
    ...
    public ExperienciaHabilidad modifyByUser(String modifyByUser) {
    ...
    public ExperienciaHabilidad modifiedOn(Instant modifiedOn) {
    ...
    public ExperienciaHabilidad auditStatus(String auditStatus) {
    ...
    public ExperienciaHabilidad empleado(Empleado empleado) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExperienciaHabilidad)) {
            return false;
        }
        return id != null && id.equals(((ExperienciaHabilidad) o).id);
    }
