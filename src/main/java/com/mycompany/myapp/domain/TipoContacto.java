...
public class TipoContacto implements Serializable {
    ...
    public TipoContacto nombre(String nombre) {
    ...
    public TipoContacto createByUser(String createByUser) {
    ...
    public TipoContacto createdOn(Instant createdOn) {
    ...
    public TipoContacto modifyByUser(String modifyByUser) {
    ...
    public TipoContacto modifiedOn(Instant modifiedOn) {
    ...
    public TipoContacto auditStatus(String auditStatus) {
    ...
    public void setContactos(Set<Contacto> contactos) {
        if (this.contactos != null) {
            this.contactos.forEach(i -> i.setTipoContacto(null));
        }
        if (contactos != null) {
            contactos.forEach(i -> i.setTipoContacto(this));
        }
        this.contactos = contactos;
    }

    public TipoContacto contactos(Set<Contacto> contactos) {
        this.setContactos(contactos);
        return this;
    }

    public TipoContacto addContacto(Contacto contacto) {
        this.contactos.add(contacto);
        contacto.setTipoContacto(this);
        return this;
    }

    public TipoContacto removeContacto(Contacto contacto) {
